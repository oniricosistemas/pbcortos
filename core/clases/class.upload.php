...
class file_upload {
    ...
    /**
     * devuelve la informacion del archivo subido
     *
     * @version 0.2
     * @author Lucas M. Sastre
     * @access Public
    ...
    /**
     * muestra los errores generados segun el idioma
     *
     * @version 0.2
     * @author Lucas M. Sastre
     * @access Public
