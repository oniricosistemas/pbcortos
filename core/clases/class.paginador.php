...
class PHPPaging {
    ...
    function porPagina ($num) {
        ...
        else return $this->error(true, "El número de elementos por página indicado es inválido. Sílo puede poner números enteros mayores o iguales a 1.");
        return true;
    }
    ...
    function linkSeparador ($separador = '', $convertir = false) {
        ...
        if($separador === 0 or $separador === '0') $this->linkSeparador = (string)'0'; // Arreglado v2.1 (Gracias a Cuauhtmoc)
     ...
     *	@param string $msg Mensaje que será incluido en los links
     *	@returns void
     **/
     ...
     *
     *	Indique que variables desea mantener en la URL al momento de generar los links para
